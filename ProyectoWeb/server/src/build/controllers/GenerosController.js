...
class GenerosController {
    ...
    UpdateGeners(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const respuesta = yield database_1.default.query("UPDATE Generos set ? WHERE generoID = ?", [req.body, id]);
            res.json(respuesta);
        });
    }
    DeleteGeners(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
