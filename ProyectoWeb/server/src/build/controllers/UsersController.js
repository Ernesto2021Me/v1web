...
class UsersController {
    ...
    ShowUsers(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const respuesta = yield database_1.default.query(`SELECT U.usuarioID, U.nombre, U.correoElectronico
        FROM Usuarios U
    ...
    SearchUserpersonal(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const respuesta = yield database_1.default.query('SELECT U.usuarioID, U.nombre, U.correoElectronico, U.contrasena ' +
                'FROM Usuarios U ' +
                'LEFT JOIN Administradores A ON U.usuarioID = A.usuarioID ' +
                'WHERE U.usuarioID = ? AND A.usuarioID IS NULL', [id]);
            res.json(respuesta);
        });
    }
    UpdateUsers(req, res) {
